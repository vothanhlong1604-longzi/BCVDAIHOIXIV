  ...
  static retrieve(transcript, rewrittenQuery, resolvedRef, storeSnapshot, convContext) {
    ...
    if (!resData) {
      ...
      return {
        ...
        memoryMessage: "Đồng chí có thể hỏi về: Báo cáo chính trị Đại hội XIV (GDP, mục tiêu 2030/2045, bộ máy, xây dựng Đảng), Báo cáo tổng kết 15 năm Điều lệ Đảng (đảng viên, tổ chức cơ sở, kỷ luật), hoặc các nghị quyết số 57, 59, 66, 68, 70, 71, 72, 79, 80.",
